...
fun Context.getMainData(): ArrayList<MainItem> {
    ...
    list.add(MainItem(CategoryItem.KEYBOARD, "utils/RKeyboard.kt", "Keyboard", ""))
    list.add(MainItem(CategoryItem.KEYHASH, "utils/RKeyHash.kt", "KeyHash", ""))
    list.add(MainItem(CategoryItem.NETWORK, "utils/RNetwork.kt", "Network", ""))
